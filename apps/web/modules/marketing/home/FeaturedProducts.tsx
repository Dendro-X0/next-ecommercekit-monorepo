...
type FeaturedProductsProps = Readonly<{
...
export function FeaturedProducts({ initialData }: FeaturedProductsProps) {
  ...
  const { data, isLoading, error } = useQuery<FeaturedResponse, Error, FeaturedResponse>({
    ...
    staleTime: 60_000,
    initialData: initialData as FeaturedResponse | undefined,
  ...
  return (
    <section
      className="py-16 bg-white dark:bg-gray-900 min-h-[720px]"
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center mb-16 space-y-2">
          <span className="text-sm font-semibold tracking-wider text-primary uppercase">Fresh Drops</span>
          <h2 className="text-3xl md:text-4xl font-bold text-center text-foreground tracking-tight">New Arrivals</h2>
        </div>
